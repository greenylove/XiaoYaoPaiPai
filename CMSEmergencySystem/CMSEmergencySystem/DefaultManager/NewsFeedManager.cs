...
namespace CMSEmergencySystem
{
    public partial class Default : System.Web.UI.Page
    {
            ...
            private void RefreshSocialFeed()
            {
                ...
                //    WebRequest request = WebRequest.Create("https://graph.facebook.com/CMSXiaoYaoPai/posts?fields=full_picture,picture,message,created_time,comments{comment_count},likes,link,name,admin_creator,description,caption&limit=10&access_token=" + FBAccessToken);
